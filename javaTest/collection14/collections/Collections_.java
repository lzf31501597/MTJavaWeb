package com.javaTest.collection14.collections;
...
public class Collections_ {
    public static void main(String[] args) {
        ...
        //swap(List list，int i， int j):将指定 list集合中的 i 处元素和 j 处元素进行交换
        ...
        //Object min(Collection，Comparator) //上面的两个方法，参考 max 即可
