...
public class Map01 {
    public static void main(String[] args) {
        ...
        //7. key 和 value 之间存在单向一对一关系，即通过指定的 key 总能找到对应的 value Map map = new HashMap();
        //8.Map存放数据的key-value，一对k-v就是一个HashMap$Node中的，有因为Node实现了Entry接口，
        //  （有些书上说一对k-v就是一个 Entry）
