...
public class HomeWork0203 {
	...
	public static void main(String[] args) {
		Teacher teacher1 = new Professor("tom", 45, "教授", 20000,1.3);
		System.out.println(teacher1.introduce());
		Teacher teacher2 = new Associate_Professor("green", 35, "副教授", 18000, 1.2);
		System.out.println(teacher2.introduce());
		Teacher teacher3 = new Lecturer("james", 25, "讲师", 15000, 1.1);
