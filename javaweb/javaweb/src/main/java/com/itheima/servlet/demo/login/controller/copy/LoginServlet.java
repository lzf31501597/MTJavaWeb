package com.itheima.servlet.demo.login.controller.copy;
...
import com.itheima.servlet.demo.login.domain.User;
import com.itheima.servlet.demo.login.model.UserModel;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			if(existUser == null){
				...
				// 重定向到成功页面
				response.sendRedirect("/javaweb/login/success.jsp");
			}
		}catch(Exception e){
			e.printStackTrace();
